...
@section('content')
    <div class='card mt-3 mr-3 ml-3'>
        <div class="card-body">
            ...
            <form class="form-sample mt-3" action="{{ route('score_save') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="first_chance">
                            </div>
                            @error('first_chance')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="second_chance">
                            </div>
                            @error('second_chance')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
