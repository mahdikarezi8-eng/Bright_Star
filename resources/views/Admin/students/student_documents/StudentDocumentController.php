...
class StudentDocumentController extends Controller
{
        public function student_document_add(){
            ...
            return view('admin.students.student_document_add',compact('students'));
        }
        ...
        $document->save();
        return redirect()->route('student_document_list');
        }
         public function student_document_list(){
        $documents = StudentDocument::all();
        return view('admin.students.student_document_list' ,compact('documents'));
    }
    ...
    public function student_document_edit($id){
        ...
        return view('admin.students.student_document_edit',compact('document','students'));
