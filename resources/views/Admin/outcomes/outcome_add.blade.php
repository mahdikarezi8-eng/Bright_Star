...
@section('content')
    <div class='card mt-3 mr-3 ml-3'>
        <div class="card-body">
            <h4 class="card-title">Add Outcome</h4>
            <form class="form-sample mt-3" action="{{ route('outcome_save') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" name="outcome_date">
                            </div>
                            @error('outcome_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
